...
const pantalla = document.querySelector('.cuerpo');
...
boton.addEventListener('click', () => {
    nav.classList.toggle('desplegable');
...
function cambiarBoton() {
    linea1.style.transform = 'rotate(40deg)';
    linea2.style.opacity = '0';
    linea3.style.transform = 'rotate(-40deg)';
    if (boton.classList.toggle('open')) {
        linea1.style.transform = 'rotate(40deg)';
        linea2.style.opacity = '0';
        linea3.style.transform = 'rotate(-40deg)';
    } else {
...
class Tiempo extends HTMLElement {
    constructor(){
        super()
    }
    connectedCallback(){
...
customElements.define("relative-time", Tiempo)
...
class Busqueda extends HTMLElement{
    ...
    connectedCallback(){
        const open = document.querySelector('.apertura')
...
customElements.define("busqueda-dialogo" , Busqueda)
...
const articles = [
    ...
    {
      "id": 2,
      "image": "https://ichef.bbci.co.uk/news/1536/cpsprodpb/53be/live/c4fa8ca0-9627-11ef-a965-49eefc19faba.png.webp",
