...
function Finance() {
    const [noticias, setNoticias] = useState([]); // Estado para almacenar los datos
  ...
  useEffect(() => {
    ...
    const fetchPosts = async () => {
      try {
        ...
        setNoticias(data); // Guarda los datos en el estado
      } catch (err) {
  ...
  }, []); // El array vacío hace que esto solo se ejecute al cargar el componente
